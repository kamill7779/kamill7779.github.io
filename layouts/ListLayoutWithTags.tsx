...
function Pagination({ totalPages, currentPage }: PaginationProps) {
  ...
  return (
    <div className="flex justify-between pt-6 pb-8">
      ...
      <span className="text-on-surface-variant font-[family-name:var(--font-inter)] text-xs tracking-widest uppercase">
  ...
  return (
    <main className="mx-auto max-w-7xl px-8 pt-40 pb-24">
      ...
      <header className="mb-24">
        <h1 className="text-on-surface mb-6 font-[family-name:var(--font-inter)] text-[3.5rem] leading-none font-black tracking-tighter">
          {title}
        </h1>
        ...
        {years.map((year) => (
          <section key={year} className="editorial-grid">
            <aside className="pt-2">
              <h2 className="text-on-surface sticky top-28 font-[family-name:var(--font-inter)] text-4xl font-black tracking-tighter">
                {year}
              </h2>
            </aside>
                  ...
                  <article key={path} className="group cursor-pointer">
                    <Link href={`/${path}`}>
                      <div className="flex flex-col gap-3">
                        <div className="text-on-surface-variant flex items-center gap-4 font-[family-name:var(--font-inter)] text-[0.75rem] tracking-widest uppercase">
                        ...
                        <h3 className="text-on-surface group-hover:text-tertiary font-[family-name:var(--font-inter)] text-2xl font-bold tracking-tight transition-colors">
                          {title}
                        </h3>
      ...
      {sortedTags.length > 0 && (
        <section className="border-outline-variant/20 mt-24 border-t pt-24">
          <div className="editorial-grid">
            <aside>
              <h4 className="text-on-surface-variant mb-8 font-[family-name:var(--font-inter)] text-xs tracking-[0.2em] uppercase">
                Browse by Topic
              </h4>
            </aside>
